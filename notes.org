...
* TASKS
** Usable
*** DONE layer operations still not given reasonable keybinds
*** TODO fix bug where any eprintln's in Controller::new_session don't get a chance because target.finalize() exit(1)'s.
