...
| Manner            | Canvas data       | Project data      | Command | Command-Line |
|-------------------|-------------------|-------------------|---------|--------------|
| New Project       | Empty             | Empty             |         |              |
| Import PNG        | From PNG          | Empty             |         |              |
| Load Canvas File  | From Canvas File  | Empty             |         |              |
| Load Project File | From Project File | From Project File |         |              |
