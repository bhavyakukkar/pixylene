...
:END:
*** Version 1.0 [22%]
**** DONE actually use layer opacity & mute in Layer::merge
...
**** DONE when saving session reconvert modified to false
**** TODO Png to/fro Scene: fill more color-type/bit-depth combos
**** TODO dirs to get actions.lua and config.toml from XDG_CONFIG_DIR/pixylene
