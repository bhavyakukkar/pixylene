...
** FUNCTIONAL [0/0]
*** NEXT [3/14]
- (libpyxelene) palette has 2 methods to change specified color [0/0]
  - [ ] changeToExisting that takes index of other color in palette
  - [ ] changeTo that takes direct hex value
  - [ ] (libpyxelene) rectangularfill takes a palette_index too
- (pixylenetui) [0/0]
